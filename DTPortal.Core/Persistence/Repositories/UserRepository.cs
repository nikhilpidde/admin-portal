...
namespace DTPortal.Core.Persistence.Repositories
{
        ...
        IUserRepository
    {
        ...
        public async Task<bool> IsUserExists(UserTable user)
        {
            ...
            {
                _logger.LogError("IsUserExists::Database exception: {0}", error);
                return false;
            }
        }
        public async Task<bool> IsUserExistsWithEmail(UserTable user)
        {
            ...
            {
                _logger.LogError("IsUserExistsWithEmail::Database exception: {0}", error);
                return false;
            }
        }
        public async Task<bool> IsUserExistsWitMobile(UserTable user)
        {
            ...
            {
                _logger.LogError("IsUserExistsWitMobile::Database exception: {0}", error);
                return false;
            }
        }
        public async Task<PaginatedList<UserTable>> GetAllUsersWithRolesAsync(int offset, int count)
        {
            ...
            {
                _logger.LogError("GetAllUsersWithRolesAsync::Database exception: {0}", error);
                return null;
            }
        }
        ...
        public async Task<UserTable> GetUserByIdWithRoleAsync(int id)
        {
            ...
            {
                _logger.LogError("GetUserByIdWithRoleAsync::Database exception: {0}", error);
                return null;
            }
        }
        ...
        public async Task<bool> IsUserExistsbyUserNameAsync(string userName)
        {
            ...
            {
                _logger.LogError("IsUserExistsbyUserNameAsync::Database exception: {0}", error);
                return false;
            }
        }
        public async Task<bool> IsUserExistsbyUuidAsync(string Uuid)
        {
            ...
            {
                _logger.LogError("IsUserExistsbyUuidAsync::Database exception: {0}", error);
                return false;
            }
        }
        public async Task<UserTable> GetUserbyNameAsync(string userName)
        {
            ...
            {
                _logger.LogError("GetUserbyNameAsync::Database exception: {0}", error);
                return null;
            }
        }
        public async Task<UserTable> GetUserbyUuidAsync(string Uuid)
        {
            ...
            {
                _logger.LogError("GetUserbyUuidAsync::Database exception: {0}", error);
                return null;
            }
        }
        public async Task<UserTable> GetUserbyEmailAsync(string emailId)
        {
            ...
            {
                _logger.LogError("GetUserbyEmailAsync::Database exception: {0}", error);
                return null;
            }
        }
        ...
        public async Task<UserTable> GetUserbyPhonenoAsync(string phoneNo)
        {
            ...
            {
                _logger.LogError("GetUserbyPhonenoAsync::Database exception: {0}", error);
                return null;
            }
        }
